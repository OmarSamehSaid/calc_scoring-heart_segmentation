...
class SegmentationHeart(TaskConfig):
    def init(self, name: str, model_dir: str, conf: Dict[str, str], planner: Any, **kwargs):
        ...
        if strtobool(self.conf.get("use_pretrained_model", "false")):
            ...
            url = f"{url}/radiology_segmentation_segresnet_heart.pt"
    ...
    def infer(self) -> Union[InferTask, Dict[str, InferTask]]:
        task: InferTask = lib.infers.SegmentationHeart(
            path=self.path,
    ...
    def trainer(self) -> Optional[TrainTask]:
        ...
        task: TrainTask = lib.trainers.SegmentationHeart(
            ...
            description="Train Segmentation Heart Model",
            labels=self.labels,
        )
        return task
