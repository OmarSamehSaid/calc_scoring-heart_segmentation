...
class SegmentationHeart(BasicInferTask):
    """
    This provides Inference Engine for pre-trained SegmentationHeart (SegResNet) model.
    """
    ...
    def __init__(
        ...
        labels=None,
        dimension=3,
        description="A pre-trained model for volumetric (3D) SegmentationHeart from CT image",
        **kwargs,
    ):
        super().__init__(
            path=path,
